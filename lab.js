...
for (i = 0, len = myString.length; i < len; ++i) {
    mostFrequentChar = myString.charAt(i);
    count = frequencyObj[mostFrequentChar];
    frequencyObj[mostFrequentChar] = count ? count + 1 : 1;
}
for(mostFrequentChar in frequencyObj){
console.log(mostFrequentChar + " count: " + frequencyObj[mostFrequentChar])
}
